require.config({
    ...
    paths: {
        ...
        'jquery': '/public/assets/js/vendors/jquery-3.2.1.min',
        'validate': '/public/assets/js/vendors/jquery.validate.min',
        'bootstrap': '/public/assets/js/vendors/bootstrap.bundle.min',
